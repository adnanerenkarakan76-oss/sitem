...
good_ig = 0
infoinsta = {}
eizon_header = render('ᴄᴀᴇѕᴀʀ', colors=['white', 'red'], align='center')
ID =input('\033[1;31m 𝐼\033[1;34m𝐷 \033[1;32m \033[1;35m ♕ -  : ')
TOKEN =input('\n\033[1;31m   𝑇\033[1;32m 𝑂 \033[1;33m 𝐾 \033[1;34m 𝐸 \033[1;36m 𝑁 \033[1;35m ♕ - :')
import os
import webbrowser
webbrowser.open("https://t.me/T_9ci1")
...
def pppp():
   ...
   ▶︎ •၊၊||၊|။||||။‌‌‌‌‌၊|• 0:10
      ...
      ✩♬ ₊̊.🎧⋆☾⋆⁺₊✧
                                         ⠀⠀⠀⠀⠀⠀⠀⠀⠀
{cyan}═══════════════════════════════════════{W1}
{magenta}✦ {W2}🌟 HELLO 🌟 {W1}💎{W5}{green}
{W1}{magenta}✦
{W5} 💚 Good Insta {W1} ✅ {orange}{bt}
{W1}{magenta}✦
{W1}🔥\033[36 BaD Insta {W1} ❌ {red}{be}
{W1}{magenta}✦
{W1}⚡\033[32 Pro Insta {W1} ♻️ {cyan}{ge}
{W1}{magenta}✦
{cyan}═══════════════════════════════════════''')
